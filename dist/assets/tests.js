...
define('crud-in-class/tests/controllers/artists/artist.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/artists/artist.js should pass jshint.\ncontrollers/artists/artist.js: line 1, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/artists/artist.js: line 3, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/artists/artist.js: line 36, col 29, \'arrow function syntax (=>)\' is only available in ES6 (use \'esversion: 6\').\n\n3 errors');
  });
});
define('crud-in-class/tests/controllers/artists/new.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/artists/new.js should pass jshint.\ncontrollers/artists/new.js: line 1, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/artists/new.js: line 3, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/artists/new.js: line 21, col 29, \'arrow function syntax (=>)\' is only available in ES6 (use \'esversion: 6\').\n\n3 errors');
  });
});
...
define('crud-in-class/tests/routes/artists/new.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/artists/new.js should pass jshint.\nroutes/artists/new.js: line 1, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\nroutes/artists/new.js: line 3, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\nroutes/artists/new.js: line 19, col 5, Unreachable \'return\' after \'return\'.\n\n3 errors');
  });
});
